alert(`Doğum Tarihine Göre Burç Bulma Sistemine Hoşgeldiniz.`);
alert(`Lütfen doğduğunuz ay ve günü rakan olarak giriniz`);
let ay = Number(prompt(`Doğduğunuz Ay: `));
let gun = Number(prompt(`Doğduğunuz Gün: `));
